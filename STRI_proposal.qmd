...
df <- data.frame(
  Product = c("MAPBIOMAS", "GEDI", "ESA Biomass Climate Change", "Asner"),
  Source = c("Landsat and MODIS (Optical)", "ISS LiDAR", "Satellite SAR and LiDAR", "Airborne LiDAR"),
  YearsAvailable = c(12, 123, 1, 1),
  YearReleased = c(12, 123, 1, 1)
)
kable(df, align = "c")
...
### Aim 3 – Incorporating secondary forest persistence
